...
class Node:
    ...
    def __init__(self, state, parent=None, action=None, path_cost=0):
        ...
        # *** NUEVO: Atributo para registrar el orden de expansión ***
...
def breadth_first_graph_search(problem):
    """[Figure 3.11]
    Se modifica para devolver una lista de nodos en orden de generación (FIFO)
    para la correcta visualización del árbol.
    """
    node = Node(problem.initial)
